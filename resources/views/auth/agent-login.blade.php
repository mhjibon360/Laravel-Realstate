...
<head>
    ...
    <title>realstae | agent login</title>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8 ps-md-0">
                                    <div class="auth-form-wrapper px-4 py-5">
                                        <a href="#"
                                            class="noble-ui-logo logo-light d-block mb-2">Agent<span>Login</span></a>
                                        ...
                                        <form class="forms-sample" method="POST" action="{{ route('login') }}">
                                            ...
                                            <p class="text-muted d-block mt-3">Don't
                                                have an account? <a href="{{ route('agent.register') }}" class=" ">
                                                    Sign up</a></p>
