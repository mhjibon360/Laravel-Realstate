...
<body>
    <div class="main-wrapper">
        ...
        @include('agent.layouts.inc.side-nav')
            ...
            <div class="sidebar-body">
                ...
                <div class="theme-wrapper">
                    ...
                    <a class="theme-item" href="../demo1/dashboard.html">
                        <img src="{{ asset('agent') }}/assets/images/screenshots/light.jpg" alt="light theme">
                    </a>
                    <h6 class="text-muted mb-2">Dark Theme:</h6>
                    <a class="theme-item active" href="../demo2/dashboard.html">
                        <img src="{{ asset('agent') }}/assets/images/screenshots/dark.jpg" alt="light theme">
                    </a>
                </div>
            </div>
        </nav>
        ...
        <div class="page-wrapper">
            ...
            @include('agent.layouts.inc.top-nav')
            <!-- partial -->
            <div class="page-content">
                @yield('agent_content')
            </div>
            <!-- partial:partials/_footer.html -->
            @include('agent.layouts.inc.footer')
            <!-- partial -->
        </div>
    </div>
