    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                <div class="card mt-1">
                    <div class="card-body">
                        <h4 class=" text-capitalize fw-semibold">Edit property</h4>
                        <hr>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="buy_rent_type" id="buy_rent_type"
                                            ...
                                            <option value="buy"
                                                {{ $property->buy_rent_type == 'buy' ? 'selected' : '' }}>Buy</option>
                                            <option value="rent"
                                                {{ $property->buy_rent_type == 'rent' ? 'selected' : '' }}>Rent</option>
                                        </select>
                                        @error('buy_rent_type')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                        ...
                                        <select name="propertytype_id" id="propertytype_id"
                                            ...
                                            @foreach ($allpropertytype as $ptype)
                                                <option value="{{ $ptype->id }}"
                                                    {{ $property->propertytype_id == $ptype->id ? 'selected' : '' }}>
                                                    {{ $ptype->property_typename }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="property_descriptions" id="tinymceExample" rows="5"
                                            class="form-control {{ $errors->has('property_descriptions') ? 'is-invalid' : '' }}">{!! $property->property_descriptions !!}</textarea>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="amenities" id="tags"
                                            ...
                                            value="{{ $property->amenities }}" data-role="tagsinput" />
                                        @error('amenities')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="zip_postal_code" id="zip_postal_code"
                                            ...
                                            value="{{ $property->zip_postal_code }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="page_statistics_image" id="photo"
                                            ...
                                            data-default-file="{{ asset($property->page_statistics_image) }}" />
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" name="thumbnail" id="thumbnail"
                                            ...
                                            data-default-file="{{ asset($property->thumbnail) }}" />
                                    </div>
                                </div>
                                <!--from group-->
