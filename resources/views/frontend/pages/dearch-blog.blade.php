...
@section('title', $searchkeyword['title'])
@section('main')
    <!--Page Title-->
        ...
        <div class="auto-container">
            <div class="row clearfix">
                ...
                <div class=" text-center" style="width: 100%;">
                    <h4 class=" text-danger font-bold text-center d-block">no result found</h4>
                </div>
                @endforelse
            </div>
            <div class="pagination-wrapper">
                {!! $searchnews->links('pagination::my-pagination') !!}
            </div>
        </div>
    </section>
    <!-- sidebar-page-container -->
