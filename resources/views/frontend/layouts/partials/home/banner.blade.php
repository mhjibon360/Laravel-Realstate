                             ...
                             <div class="inner-box">
                                 <div class="top-search">
                                     <form action="{{ route('property.list') }}" method="get" class="search-form">
                                         @csrf
                                         @method('GET')
                                         <input type="hidden" value="buy" name="filter[buy_rent_type]">
                                         <div class="row clearfix">
                                             <div class="col-lg-4 col-md-12 col-sm-12 column">
                                                 <div class="form-group">
                                                     ...
                                                     <div class="field-input">
                                                         ...
                                                         <input type="search" name="filter[property_name]"
                                             ...
                                             <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                 <div class="form-group">
                                                     ...
                                                     <div class="select-box">
                                                         ...
                                                         <select class="wide" name="filter[location_id]">
                                             ...
                                             <div class="col-lg-4 col-md-6 col-sm-12 column">
                                                 <div class="form-group">
                                                     ...
                                                     <div class="select-box">
                                                         <select class="wide" name="filter[propertytype_id]">
                                                             <option data-display="All Type">All Type</option>
                                                             @foreach ($allpropertytype as $type)
                                                                 <option value="{{ $type->id }}">
                                                                     {{ $type->property_typename }}</option>
                                                             @endforeach
                                                         </select>
                                                     </div>
                                                 </div>
