            ...
            <div class="card">
                ...
                <div class="d-flex justify-content-center p-3 rounded-bottom">
                    <ul class="d-flex align-items-center m-0 p-0">
                        ...
                        <li class="d-flex align-items-center  {{ $routeurl == 'admin.edit.profile' ? 'active' : '' }}">
                            <i class="me-1 icon-md  {{ $routeurl == 'admin.edit.profile' ? 'text-primary' : 'text-white' }}"
                                data-feather="columns"></i>
                            <a class="pt-1px d-none d-md-block {{ $routeurl == 'admin.edit.profile' ? 'text-primary' : 'text-white' }}"
                                href="#">Profile</a>
                        </li>
                        &nbsp;&nbsp;&nbsp;
                        <li class="d-flex align-items-center {{ $routeurl == 'admin.change.password' ? 'active' : '' }}">
                            <i class="me-1 icon-md {{ $routeurl == 'admin.change.password' ? 'text-primary' : 'text-white' }}"
                                data-feather="columns"></i>
                            <a class="pt-1px d-none d-md-block {{ $routeurl == 'admin.change.password' ? 'text-primary' : 'text-white' }}"
                                href="#">Password</a>
                        </li>
