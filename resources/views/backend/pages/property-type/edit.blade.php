    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                <div class="card mt-4">
                    <div class="card-body">
                        <h4 class=" text-capitalize fw-semibold">Edit Property Type</h4>
                        <hr>
                        <form action="{{ route('admin.property-type.update', $ptype->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <!--from group-->
                            <div class="mb-3">
