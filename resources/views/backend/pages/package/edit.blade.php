    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="row">
                <div class="card mt-4">
                    <div class="card-body">
                        <h4 class=" text-capitalize fw-semibold">Edit package</h4>
                        <hr>
                        <form action="{{ route('admin.package-plan.update', $plan->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <!--from group-->
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" name="package_validitytime" id="package_validitytime"
                                            ...
                                            value="{{ $plan->package_validitytime }}" />
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="account_dashboard_status" id="account_dashboard_status"
                                            ...
                                            <option value="1"
                                                {{ $plan->account_dashboard_status == '1' ? 'selected' : '' }}>yes</option>
                                            <option value="0"
                                                {{ $plan->account_dashboard_status == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="invoice_status" id="invoice_status"
                                            ...
                                            <option value="1"  {{ $plan->invoice_status == '1' ? 'selected' : '' }}>yes</option>
                                            <option value="0"  {{ $plan->invoice_status == '0' ? 'selected' : '' }} >No</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="online_payment_status" id="online_payment_status"
                                            ...
                                            <option value="1" {{ $plan->online_payment_status == '1' ? 'selected' : '' }}>yes</option>
                                            <option value="0" {{ $plan->online_payment_status == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="brand_website_status" id="brand_website_status"
                                            ...
                                            <option value="1"  {{ $plan->brand_website_status == '1' ? 'selected' : '' }}>yes</option>
                                            <option value="0"  {{ $plan->brand_website_status == '0' ? 'selected' : '' }}>No</option>
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <select name="account_manager_status" id="account_manager_status"
                                            ...
                                            <option value="1"  {{ $plan->premium_app_status == '1' ? 'selected' : '' }}>yes</option>
                                            <option value="0"  {{ $plan->premium_app_status == '0' ? 'selected' : '' }}>No</option>
                                        </select>
