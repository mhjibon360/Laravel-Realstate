            ...
            <div class="card rounded">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <p class="text-muted"> {{ $customer->created_at->format('F d,Y') }}</p>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3 d-flex social-links">
                        <a href="{{ $customer->facebook }}" class="btn btn-icon border btn-xs me-2">
                            <i data-feather="github"></i>
                        </a>
                        <a href="{{ $customer->twitter }}" class="btn btn-icon border btn-xs me-2">
                            <i data-feather="twitter"></i>
                        </a>
                        <a href="{{ $customer->google }}" class="btn btn-icon border btn-xs me-2">
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route('admin.update.customer.account', $customer->id) }}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control {{ $errors->has('details') ? 'is-invalid' : '' }}" name="details" id="details"
                                            rows="3">{{ $customer->details }}</textarea>
                                        @error('details')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ isset($customer->photo) ? asset($customer->photo) : Avatar::create($customer->name)->toBase64() }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img src="{{ isset($customer->cover_photo) ? asset($customer->cover_photo) : Avatar::create($customer->username)->toBase64() }}"
